...
const AccessibilityNav = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          className="absolute top-0 right-0 translate-x-[100%] translate-y-[-100%] mt-2 rounded-2xl shadow-xl border-2 border-yellow-200/50 dark:border-violet-400/30 dark:bg-gray-800/95 bg-white/95 backdrop-blur-sm p-4 w-52 min-h-48 md:w-56 md:min-h-52"
