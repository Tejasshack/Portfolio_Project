...
const ThemeSwitch = () => {
  ...
  return (
    <ToggleSwitch
      ...
      inactiveBgClass="bg-yellow-500 ring-2 ring-brown5 dark:ring-gray-600"
      activeIcon={<MoonIcon className="size-6 text-violet-400" />}
      inactiveIcon={<SunIcon className="size-6 text-yellow-500" />}
    />
  )
}
